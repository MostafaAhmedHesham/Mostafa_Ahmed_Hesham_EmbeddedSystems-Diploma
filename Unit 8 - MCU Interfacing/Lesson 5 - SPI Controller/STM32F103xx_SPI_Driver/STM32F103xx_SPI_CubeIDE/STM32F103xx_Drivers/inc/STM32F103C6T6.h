...
#define SPI2_BASE		0x40003800UL	//APB1
...
//USART - Connectivity Lines
#define USART1_IRQ		37
#define USART2_IRQ		38
#define USART3_IRQ		39


//SPI - Connectivity Lines
#define SPI1_IRQ		35
#define SPI2_IRQ		36
...
#define NVIC_USART1_EN()	(*NVIC_ISER1 |= (1 << (USART1_IRQ - 32)))
#define NVIC_USART2_EN()	(*NVIC_ISER1 |= (1 << (USART2_IRQ - 32)))
#define NVIC_USART3_EN()	(*NVIC_ISER1 |= (1 << (USART3_IRQ - 32)))

#define NVIC_SPI1_EN()		(*NVIC_ISER1 |= (1 << (SPI1_IRQ - 32)))
#define NVIC_SPI2_EN()		(*NVIC_ISER1 |= (1 << (SPI2_IRQ - 32)))
...
#define NVIC_USART1_Disable()		(*NVIC_ICER1 |= (1 << (USART1_IRQ - 32)))
#define NVIC_USART2_Disable()		(*NVIC_ICER1 |= (1 << (USART2_IRQ - 32)))
#define NVIC_USART3_Disable()		(*NVIC_ICER1 |= (1 << (USART3_IRQ - 32)))
