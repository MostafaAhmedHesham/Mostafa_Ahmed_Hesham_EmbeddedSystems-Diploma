...
STM32F103xx_Drivers/%.o STM32F103xx_Drivers/%.su: ../STM32F103xx_Drivers/%.c STM32F103xx_Drivers/subdir.mk
	arm-none-eabi-gcc -gdwarf-2 "$<" -mcpu=cortex-m3 -std=gnu11 -g3 -DDEBUG -DSTM32 -DSTM32F1 -DSTM32F103C6Tx -c -I../Inc -I"D:/Mostafa/C and Embedded/Embedded Systems Diploma KS/Unit 8 - MCU Interfacing/Lesson 3/Assignments/STM32F103xx_UART_Driver/STM32F103xx_UART_CubeIDE/STM32F103xx_Drivers/inc" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfloat-abi=soft -mthumb -o "$@"
