...
#ifndef INC_STM32F103C6T6_EXTI_DRIVER_H_
#define INC_STM32F103C6T6_EXTI_DRIVER_H_
...
typedef struct
{
	...
	uint8_t 			Trigger_Case;	//Specifies RISING or Failing or Both Edges
										//This Parameter must be set based on @ref EXTI_Trigger_define

	uint8_t 			IRQ_Enable;		//Enable or Disable EXTI IRQ (Enables interrupt MASK and corresponding NVIC Interrupt Controller)
										//This Parameter must be set based on @ref EXTI_Enable_define

	void(*PTR_IRQ_CallBack)(void);		//Set C function you want to be Called once IRQ Happen
...
#endif /* INC_STM32F103C6T6_EXTI_DRIVER_H_ */
